...
public class ViewAllStudent extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<br>");
		out.println("<table border='4' width='60%' align='center'");
		...
		try
		{
			...
			while(rs.next())
			{
				...
				out.println("<td><a href='delete?userid="+regid+"'>Delete</a></td>");
				out.println("<td><a href='update?userid="+regid+"'>Update</a></td>");
				out.println("</tr>");
			}
